...
REAL(4), PARAMETER           :: PC_RefSpd     =     126.95                    ! Desired (reference) HSS speed for pitch controller, rad/s.
...
REAL(4), PARAMETER           :: VS_RtGnSp     =     125.6805                    ! Rated generator speed (HSS side), rad/s. -- chosen to be 99% of PC_RefSpd
